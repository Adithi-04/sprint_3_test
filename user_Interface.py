...
def check_rtf(file_path):
    ...
    for i in rtf_tags:
        ...
        logging1.write_exceptions(i + " not in RTF \n")
        flag = False
        break
    return flag
...
def test_special_characters_positive():
    ...
    logger.info("Starting positive test case for special characters.")
    ...
    for file in valid_files:
        try:
            ...
            pytest.fail(f"Failed to verify processed content for file {file}.")
...
def test_special_characters_negative():
    ...
    logger.info("Starting negative test case for special characters.")
    ...
    for file in invalid_files:
        try:
            ...
            pytest.fail(f"Failed to verify absence of processing for file {file}.")
